...
# chatbot_commerce/
APPS_DIR = ROOT_DIR / "chatbot_commerce"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "chatbot_commerce.contrib.sites.migrations"}
...
DEPARTMENT_CATEGORIES = env("DEPARTMENT_CATEGORIES")
...
URL_DEPARTMENT_CATEGORIES = f'https://{STORE_NAME}.{ENVIROMENT_VTEX}/{DEPARTMENT_CATEGORIES}'
