...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["keybe-commerce.smk.agency", "www.keybe-commerce.smk.agency", "qa.keybe-commerce.smk.agency"])
...
STATIC_URL = f"https://{aws_s3_domain}/qa/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "chatbot_commerce.utils.storages.MediaRootS3Boto3Storage"
MEDIA_URL = 'https://{}/qa'.format(AWS_S3_CUSTOM_DOMAIN)
